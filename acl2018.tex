...
Limitations of the models above is that they can only deal with very short documents.
...
However, summarization must be able to deal with much longer documents.
...
Researchers also base their model on the encoder-decoder framework, however, instead of focusing on attention to get the local context like most of the recent work does, they distract the models to different parts of a document to avoid focusing on only one thing and get the full picture.
