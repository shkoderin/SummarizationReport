...
MeaningCloud provides its Summarization API for free \cite{meaaningcloud2017api}. It is based on the extractive summarization approach, producing multilingual summaries of a desired length.
