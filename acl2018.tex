...
The approach was evaluated on three datasets: Daily Mail, joint CNN/Daily Mail and Out-of-Domain DUC 2002 corpus.
Results on Daily Mail corpus were compared to the ones of \cite{cheng2016neural} using Rouge recall with summary length restricted to 75 and 275 bytes.
...
On the joint CNN/Daily Mail corpus, SummaRuNNer significantly outperforms the abstractive model of \cite{nallapati2016abstractive}, which was the only work at the time, that reported performance on this dataset.
